...
Axiom Q_MultisetReorder_UpperBound :
  forall (Mint:addr -> Numbers.BinNums.Z) (Mint1:addr -> Numbers.BinNums.Z)
  ...
  P_UpperBound_1_ Mint1 a 0%Z n v -> P_UpperBound_1_ Mint a 0%Z n v.
...
Proof.
  ...
  enough (X: P_SomeEqual_1_ K a 0 m (L(shift a 0))).
