...
Theorem wp_goal :
  ...
  (i <= i1)%Z -> is_sint32_chunk t -> is_sint32 i2 ->
  (0%Z <= (L_CountNotEqual_1_ t a i i1 i2))%Z.
(* Why3 intros t a i i1 i2 h1 h2 h3. *)
Proof.
  Require Import Psatz.
  intros L a m n v MN L32 V32.
  ...
  }
  {
    ...
    assert(neq_eq: (L(shift a (m + z)) <> v \/ L(shift a (m + z)) = v)%Z) by lia.
