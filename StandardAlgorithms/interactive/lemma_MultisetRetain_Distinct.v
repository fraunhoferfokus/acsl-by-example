...
Axiom Q_MultisetMinus_Distinct :
  forall (Mint:addr -> Numbers.BinNums.Z) (Mint1:addr -> Numbers.BinNums.Z)
    (a:addr) (v:Numbers.BinNums.Z) (m:Numbers.BinNums.Z)
    (n:Numbers.BinNums.Z),
  ~ ((L_At Mint a m) = v) -> ((L_At Mint1 a m) = v) -> (0%Z <= m)%Z ->
  (m < n)%Z -> is_sint32_chunk Mint -> is_sint32_chunk Mint1 ->
  is_sint32 v -> P_MultisetReorder_1_ Mint Mint1 a 0%Z m ->
...
Theorem wp_goal :
  ...
  ~ ((L_At t1 a i) = i2) -> ~ ((L_At t a i) = i2) -> (0%Z <= i)%Z ->
