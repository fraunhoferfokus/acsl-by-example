...
Theorem wp_goal :
  ...
  ~ (x = i3) -> ((i1 + (L_FindNotEqual_1_ t a i1 i i3))%Z = i) ->
  (i < i2)%Z -> (i1 <= i)%Z -> is_sint32_chunk t -> is_sint32 i3 ->
  is_sint32 x -> ((i1 + (L_FindNotEqual_1_ t a i1 i2 i3))%Z = i).
(* Why3 intros t a i i1 i2 i3 x h1 h2 h3 h4 h5 h6 h7. *)
Proof.
  Require Import Psatz.
  intros L a k m n v ak Neq Found Upper Lower Chunk V AK.
  subst ak.
  remember (n - m)%Z as p.
