...
Theorem wp_goal :
  ...
  is_sint32_chunk t -> is_sint32 i3 ->
  P_StrictLowerBound_1_ t (shift a i) i1 i2 i3 ->
  P_StrictLowerBound_1_ t a (i + i1)%Z (i + i2)%Z i3.
(* Why3 intros t a i i1 i2 i3 h1 h2 h3. *)
Proof.
  ...
  intros L a b c d v L32 V32 LowerBound i X Y.
