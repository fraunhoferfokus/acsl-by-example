...
Axiom Q_Find_Limit :
  ...
  is_sint32 v -> is_sint32 x -> ((m + (L_Find_1_ Mint a m n v))%Z <= k)%Z.
...
Axiom Q_Find_Upper :
  forall (Mint:addr -> Numbers.BinNums.Z) (a:addr) (v:Numbers.BinNums.Z)
    (m:Numbers.BinNums.Z) (n:Numbers.BinNums.Z),
  (m <= n)%Z -> is_sint32_chunk Mint -> is_sint32 v ->
  ((m + (L_Find_1_ Mint a m n v))%Z <= n)%Z.

Axiom Q_Find_Lower :
  forall (Mint:addr -> Numbers.BinNums.Z) (a:addr) (v:Numbers.BinNums.Z)
    (m:Numbers.BinNums.Z) (n:Numbers.BinNums.Z),
  is_sint32_chunk Mint -> is_sint32 v -> (0%Z <= (L_Find_1_ Mint a m n v))%Z.
...
Axiom Q_Find_MissMiss :
  ...
  ((m + (L_Find_1_ Mint a m x1 v))%Z = x1).
...
Theorem wp_goal :
  ...
  P_NoneEqual_1_ t a i i1 i2 -> ((i + (L_Find_1_ t a i i1 i2))%Z = i1).
(* Why3 intros t a i i1 i2 h1 h2 h3 h4. *)
Proof.
 Require Import Psatz.
  intros t a m n v MN VChunk V None.
