...
void test_max_element2(const std::vector<value_type>& a)
{
  const size_type pos = max_element2(a.data(), a.size());
...
int main(int, char**)
{
  ...
  test_max_element2({2, 9, 1, 9, 3});
  test_max_element2({9, 9, 9});
  test_max_element2({1, 2, 3, 9});
  test_max_element2({9, 3, 2, 1});
